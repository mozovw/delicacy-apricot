package com.delicacy.apricot.blog.config;

import com.delicacy.apricot.blog.service.UserService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .and().formLogin().loginPage("/login_page").successHandler(successHandler).failureHandler(authenticationFailureHandler).loginProcessingUrl("/login")
