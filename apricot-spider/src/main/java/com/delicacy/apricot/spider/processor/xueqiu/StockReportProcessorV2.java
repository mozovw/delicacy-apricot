...
@Slf4j
public class StockReportProcessorV2 extends AbstactProcessor {


    static final String URL_POST = "https://stock.xueqiu.com/v5/stock/finance/";

    static final String URL_PRE_HK[] = {
            "https://stock.xueqiu.com/v5/stock/finance/hk/indicator.json?symbol=%s&type=Q1&is_detail=true&count=5&timestamp=",
            "https://stock.xueqiu.com/v5/stock/finance/hk/indicator.json?symbol=%s&type=Q2&is_detail=true&count=5&timestamp=",
            "https://stock.xueqiu.com/v5/stock/finance/hk/indicator.json?symbol=%s&type=Q3&is_detail=true&count=5&timestamp=",
            "https://stock.xueqiu.com/v5/stock/finance/hk/indicator.json?symbol=%s&type=Q4&is_detail=true&count=5&timestamp="
    };

    static final String URL_PRE[] = {
            "https://stock.xueqiu.com/v5/stock/finance/cn/indicator.json?symbol=%s&type=Q1&is_detail=true&count=5&timestamp=",
            "https://stock.xueqiu.com/v5/stock/finance/cn/indicator.json?symbol=%s&type=Q2&is_detail=true&count=5&timestamp=",
            "https://stock.xueqiu.com/v5/stock/finance/cn/indicator.json?symbol=%s&type=Q3&is_detail=true&count=5&timestamp=",
            "https://stock.xueqiu.com/v5/stock/finance/cn/indicator.json?symbol=%s&type=Q4&is_detail=true&count=5&timestamp="
    };
